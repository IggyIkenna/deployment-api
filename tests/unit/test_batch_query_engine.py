...
class TestGetExpectedDatesForAssetGroup:
    ...
    def test_no_start_date_returns_all_dates(self):
        ...
        config = {}
        result = get_expected_dates_for_asset_group(all_dates, config, "instruments-service", "CEFI")
    ...
    def test_filters_dates_before_asset_group_start(self):
        ...
        with patch("deployment_api.routes.batch_query_engine.get_asset_group_start_date") as mock_start:
...
class TestQuerySpecificPrefixesForAssetGroup:
    ...
    def test_empty_dates_returns_empty(self):
        ...
        with (
            ...
            result = query_specific_prefixes_for_asset_group("svc", "CEFI", set(), None, None, None, "", {}, set())
        assert result["found_dates"] == set()
...
class TestQueryGenericPrefixesForAssetGroup:
    ...
    def test_returns_error_when_no_bucket(self):
        with patch("deployment_api.routes.batch_query_engine.BUCKET_MAPPING", {"svc": {}}):
            result = query_generic_prefixes_for_asset_group("svc", "UNKNOWN_CAT", {"2026-01-01"}, None, "")
        assert "error" in result
    ...
    def test_found_date_tracked(self):
        ...
        with (
            ...
            result = query_generic_prefixes_for_asset_group("instruments-service", "CEFI", {"2026-01-15"}, None, "")
        assert "2026-01-15" in result["found_dates"]
    ...
    def test_sub_dimension_tracked(self):
        mock_pc = MagicMock()
        mock_pc.get_service_prefixes_for_date.return_value = [("feature_group_a/", "feature_group_a")]
        ...
        with (
            ...
            result = query_generic_prefixes_for_asset_group("features-delta-one", "CEFI", {"2026-01-15"}, None, "")
