...
from deployment_api.routes.data_status_helpers import _bucket
...
class TestBucketHelper:
    ...
    def test_bucket_name_format(self):
        with patch("deployment_api.routes.data_status_helpers._PID", "my-project-123"):
...
class TestRunDataStatusCli:
    ...
    async def test_successful_cli_returns_dict(self):
        ...
        with patch("asyncio.create_subprocess_exec", return_value=mock_proc):
            with patch("asyncio.wait_for", return_value=(fake_output, b"")):
    ...
    async def test_failed_cli_raises_http_exception(self):
        ...
        with patch("asyncio.create_subprocess_exec", return_value=mock_proc):
            with patch("asyncio.wait_for", return_value=(b"", b"Error: something went wrong")):
