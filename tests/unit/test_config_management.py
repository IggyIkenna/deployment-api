...
# unified_trading_library.config_interface — ConfigStore, ConfigStoreError, get_config_store,
...
sys.modules.setdefault("unified_trading_library.config_interface", _mock_uci)
