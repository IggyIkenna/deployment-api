...
# Ensure unified_trading_library.events is mocked so log_event is importable
sys.modules.setdefault("unified_trading_library.events", MagicMock(log_event=MagicMock()))
