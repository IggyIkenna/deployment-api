...
class ExecutionBacktestLaunchRequest(BaseModel):  # CORRECT-LOCAL: deployment-ui launch request DTO
...
class ExecutionBacktestLaunchResult(BaseModel):  # CORRECT-LOCAL: deployment-ui launch response DTO
